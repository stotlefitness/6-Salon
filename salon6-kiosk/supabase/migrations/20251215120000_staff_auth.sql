...
select '00000000-0000-0000-0000-0000000000c1', '00000000-0000-0000-0000-000000000001', 'Walk-in', 'Guest', '+1-555-000-0000', null
...
select '00000000-0000-0000-0000-0000000000a1', '00000000-0000-0000-0000-000000000001', 'Placeholder Service', 'Autogenerated to satisfy FK backfill.', 30, 0, true
...
create policy "staff view salons" on salons
...
create policy "staff view staff_users in salon" on staff_users
  for select using (exists (
    select 1 from staff_users su
    where su.user_id = auth.uid()
...
create policy "staff manage salon customers" on customers
...
create policy "staff view stylists in salon" on stylists
  for all using (exists (
    select 1 from staff_users su
    where su.user_id = auth.uid()
...
create policy "staff view services in salon" on services
  for all using (exists (
    select 1 from staff_users su
    where su.user_id = auth.uid()
...
create policy "staff view products in salon" on products
  for all using (exists (
    select 1 from staff_users su
    where su.user_id = auth.uid()
...
create policy "staff manage bookings in salon" on bookings
  for all using (exists (
    select 1 from staff_users su
    where su.user_id = auth.uid()
...
create policy "staff manage booking services" on booking_services
  for all using (exists (
    select 1 from staff_users su
